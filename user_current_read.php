...
$sql = "SELECT * FROM user_booklist INNER JOIN booklist ON user_booklist.book_name = booklist.book_name where user_id='$user_id'  AND user_booklist.choice_list = 'Currently Reading'";
